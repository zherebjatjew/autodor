...
describe UsersController do
  ...
  describe "POST 'create_truck'" do
    describe "failure" do
      ...
      it "should not create_truck a user" do
        lambda do
          post :create_truck, :user => @attr
    ...
    describe "success" do
      ...
      it "should create_truck a user" do
        lambda do
          post :create_truck, :user => @attr
  ...
  describe "DELETE 'destroy'" do
    ...
    describe "as an admin user" do
      before :each do
        admin = Factory(:user, :email => "admin@example.com", :role => "admin")
        test_sign_in admin
      end
